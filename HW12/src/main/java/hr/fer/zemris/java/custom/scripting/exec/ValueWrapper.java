...
public class ValueWrapper {
    ...
    private Object tryToGetCorrectTypeOfArgument(Object argument) {
        ...
        if (argument instanceof String) {
            argument = tryTransformStringToDoubleOrInteger(argument);
        }

        if (value instanceof String) {
            value = tryTransformStringToDoubleOrInteger(value);
        }
     ...
     */
    private Object tryTransformStringToDoubleOrInteger(Object argument) {
        try {
            return Integer.parseInt(argument.toString());
        } catch (NumberFormatException ex) {
            return tryTransformToDouble(argument);
        }
    }
